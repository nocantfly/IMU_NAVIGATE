...
public:
	...
	;
	bool begin_I2C(uint8_t i2c_address = ICM20948_I2CADDR_DEFAULT, I2C_HandleTypeDef *i2c_handle = 0,
			int32_t sensor_id = 0);
	...
	bool getSample_byPass(imu_sample* data);
